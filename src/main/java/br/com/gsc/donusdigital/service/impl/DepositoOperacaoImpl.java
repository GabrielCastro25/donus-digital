...
@Service
public class DepositoOperacaoImpl implements Operacao<OperacaoDTO>, CustoOperacao {

    private static final BigDecimal PORCENTAGEM_GANHO_DEPOSITO = new BigDecimal(0.5);
    private static final String DESCRICAO_HISTORICO = "Depósito";
    ...
    public void efetivar(OperacaoDTO operacaoDTO) {
        ...
        final var taxa = this.calcularPorcentagem(operacaoDTO.getValor(), PORCENTAGEM_GANHO_DEPOSITO);
        this.atualizarSaldo(conta, operacaoDTO.getValor(), taxa, DESCRICAO_HISTORICO);
    }
