...
public class DepositoOperacaoImplTest {
    ...
    @InjectMocks
    private final DepositoOperacaoImpl depositoOperacao = new DepositoOperacaoImpl();
    ...
    public void efetivar_enviandoDadosValidos_esperadoSucesso() {
        ...
        this.depositoOperacao.efetivar(operacao);
